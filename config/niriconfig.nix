{...}: {
  home.file.".config/niri/config.kdl".text = ''
    ...
    output "DP-2" {
        ...
        mode "2560x1440@180.030" // 2560x1440@179.960 (current)
    ...
    binds {
        ...
        Mod+Shift+Return hotkey-overlay-title="Run an Application: rofi" { spawn "rofi-launcher"; }
        ...
        Mod+Shift+C { toggle-column-tabbed-display; }
